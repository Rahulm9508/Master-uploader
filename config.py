...
class Config(object):
    BOT_TOKEN = os.environ.get("BOT_TOKEN", "7358697038:AAG_YKpExv38VYnD5cF-9Av9RMJ5G8imorU")  # Ensure correct key name
    ...
    AUTH_USER = os.environ.get("AUTH_USERS", "7081036509").split(',')
